...
@section('title')Cash Flow {{ \Illuminate\Support\Carbon::create($report['year'], $report['month'], 1)->format('M-y') }}@endsection

@push('css')
<style>
    table.cash-flow-table { width: 100%; border-collapse: collapse; }
    table.cash-flow-table th, table.cash-flow-table td { border: 1px solid #999; padding: 3px 6px; font-size: 11px; white-space: nowrap; }
...
<div class="print-header">
    ...
    <div class="report-title"><span>Monthly Cash Flow (Operation) - {{ $report['label'] }}</span></div>
</div>
